          ...
          <div class="upload-section">
              ...
              <form action="/admin/upload" method="POST" enctype="multipart/form-data">
                  <div class="file-input">
                      <input type="file" name="media" accept="image/jpeg,image/png,image/gif,image/webp,video/mp4,video/avi,video/quicktime,video/webm,video/x-ms-wmv" required>
                  </div>
  ...
  async (req, res) => {
    try {
      ...
      const orderResult = await pool.query(
        "SELECT COALESCE(MAX(display_order), 0) + 1 as next_order FROM media"
      );
